...
import ai.classicalsearch.comparators.GCostComparator;
...
public class UniformCostSearch extends SearchAlgorithm {
    ...
    private GCostComparator gCostComparator;

    public UniformCostSearch() {
        this(false);
    }

    public UniformCostSearch(boolean verbose) {
        super(verbose);
        gCostComparator = new GCostComparator();
    }
