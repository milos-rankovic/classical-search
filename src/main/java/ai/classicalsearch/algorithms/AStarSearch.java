...
import ai.classicalsearch.comparators.FCostComparator;
...
public class AStarSearch extends SearchAlgorithm {
    ...
    private FCostComparator fCostComparator;

    public AStarSearch() {
        this(false);
    }

    public AStarSearch(boolean verbose) {
        super(verbose);
        fCostComparator = new FCostComparator();
    }
